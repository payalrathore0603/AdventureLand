...
import type { PostFormType } from "../../types/postType/PostFormType";
      ...
      >
        ...
        <div className="mb-3">
          ...
          <select
            ...
            id="category"
            onChange={handleChange}
            className="border-b-2 border-gray-400 outline-none w-1/3 text-center"
          >
        ...
        <div className=" mb-3">
          <h1 className="text-center mb-6 underline underline-offset-2">
            User Details
          </h1>
          <input
            type="text"
        ...
        <div className="text-center mt-4">
          <button
            className="border border-black m-1 p-2 rounded-md hover:bg-gray-200"
            type="submit"
          >
            Submit
          </button>
